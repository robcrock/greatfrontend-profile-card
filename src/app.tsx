function App(): React.ReactElement {
  return (
    <div className="w-80 px-6 py-10 bg-white rounded-2xl shadow-lg flex flex-col items-center">
      {/* DETAILS */}
      <section className="w-full flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Sarah Dole</h1>
      ...
      <section className="w-full">
        {/* Contact Button */}
        <button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 mb-8">
          Contact me
        </button>
